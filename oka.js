...
const reply = (teks) => {
return okta.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `${botname}`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": 'https://ibb.co/wdWbDz0',"thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/JkgLIx6RMe20QiMcKBI0ni`}}}, { quoted:m})} 
...
sourceUrl: `https://wa.me/6281262166032`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `Fitra Wahyudi`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
switch(command) {
        case 'daftar':
                ...
                if (umurUser > 50) return errorReply (`kamu terlalu tua!!`)
                if (umurUser < 12) return errorReply (`kamu terlalu kecil!!`)
...
Selamat ${ucapanWaktu} 😊
${menu}`;
     okta.sendMessage(m.chat, { text:menuu, contextInfo:{ externalAdReply: {
title: botname,
body: `Jangan Spam kk🙃`,
thumbnail: thum,
mediaType: 1,
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://chat.whatsapp.com/JkgLIx6RMe20QiMcKBI0ni`,
}}}, { quoted: fkontak })
...
case "simple":
       ...
       let taasimpel = `
┏❏═┅═━–〈 Bᴏᴛ Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : Stein Bot
┆ ☂︎ 𝙲𝚛𝚎𝚊𝚝𝚘𝚛 : ${ownername}
┆ ☂︎ 𝚄𝚙𝚝𝚒𝚖𝚎 : ⏳ ${runtime(process.uptime())}
┆ ☂︎ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${hariini}
┆ ☂︎ 𝙹𝚊𝚖: ${time} 
┗––––––––––✦
${simpel}`; okta.sendMessage(m.chat, { text:taasimpel, contextInfo:{ externalAdReply: {
title: botname,
body: `Jangan Spam kk🙃`,
thumbnail: thum,
mediaType: 1,
...
${taall}`; okta.sendMessage(m.chat, { text:oktaall, contextInfo:{ externalAdReply: {
title: botname,
body: `Jangan Spam kk🙃`,
thumbnail: thum,
mediaType: 1,
...
{ quoted: m})        
        ...
        case 'txt2img':{
if (isBan) return errorReply('Lu di ban kocak awokwok') 
if (!isCreator&&!isPrem) return errorReply('Kamu bukan premium')
...
await okta.sendMessage(m.chat, {image: txt, caption: `Done`},{quoted: m})
okta.sendMessage(m.chat, { react: { text: `✅`, key: m.key }})
     } catch (e) {
...
case 'nsfw':
if (isBan) return errorReply('*Kamu telah di ban oleh owner*')
 await loading()
reply(`
┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : Stein Bot
...
*_Social Media_*
*IG : ▣https://www.instagram.com/stein.goo*
*LINKTREE : ▣https://https://linktr.ee/stein.goo/*
*GC : ▣https://chat.whatsapp.com/JkgLIx6RMe20QiMcKBI0ni*
...
case 'infomenu':
//if (!isRegistered) return replyMsg('Kamu belum daftar!\nSilahkan daftar dengan cara *.daftar nama.umur!*')
   if (isBan) return m.reply('*Kamu Di Ban Owner Gak Usah Sok asik*')
await loading()
...
//=================================================//
       ...
       case 'addmenu':
     //  if (!isRegistered) return replyMsg('Kamu belum daftar!\nSilahkan daftar dengan cara *.daftar nama.umur!*')
     if (isBan) return m.reply('*Kamu telah di ban oleh owner*')
reply(`┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : Stein Bot
┆ ☂︎ 𝚄𝚜𝚎𝚛 : ${pushname}
┆ ☂︎ 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 : ${isPrem ? '✅' : '❎'}
...
case  'myip':
            case 'ipbot':
                ...
                case 'getcase':
if (!isCreator) return errorReply('Kamu bukan owner')
const getCase = (cases) => {
...
//=================================================//
    ...
    case 'listban':
if (isBan) return errorReply('*Kamu di ban Owner*')
 teksooop = `*List Ban*\n\n`
...
if (!isBotAdmins) return errorReply('bot bukan admin')
if (!isAdmins && !isCreator) return errorReply('admin')
...
case 'owner':{
 ...
 okta.sendContact(from, owner, fkontak)
...
「 *BOT INFO* 」
⭔Nama Creator : *Fitra Wahyudi*
⭔Nomor Creator : *${owner}*
⭔Group Official : *${ofc}*
⭔Daftar User :*${("id", db_user).length}*
⭔Versi Bot : *1.1*
⭔Botz Name : *Stein Bot*
⭔Nomor Bot : *wa.me/6282267231464*
⭔Type Baileys : *Case*
...
Terima Kasih sudah mendaftar ke dalam bot Stein Bot.
...
title: ownername,
body: 'bodynya',
thumbnailUrl: 'https://ibb.co/wdWbDz0',
...
if (!m.isGroup) return errorReply('Buat Di Group')
...
if (!isBotAdmins) return reply('Bot Bukan Admin Cuy')
    if (!isAdmins) return errorReply('lu emangnya admin?')
await loading()
